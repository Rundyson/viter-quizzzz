...
const App = () => {
  ...
  return (
    ...
    <>
      ...
      <main className='h-[calc(100vh-40px)] bg-gray-400 w-full flex justify-center items-center'>
        ...
        <div className="quiz">
            ...
            <button className={`block w-full bg-blue-700 text-white py-2 rounded-full mt-5 ${isActive == null ? "pointer-events-none" : ""}`} onClick={handleNextQuestion}>Next Question</button>
        </div>)}
